...
class MetricRecord(models.Model):
    ...
    tags = models.ManyToManyField(Tag, related_name='metric_records', through='TagsMetricRecord', blank=True,)
    metric_name = models.CharField(verbose_name='Имя метрики', max_length=256, blank=True, null=True,)
